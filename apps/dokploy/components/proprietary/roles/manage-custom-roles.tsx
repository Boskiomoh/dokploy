...
const RESOURCE_META: Record<string, { label: string; description: string }> = {
	...
	traefikFiles: {
		...
		description: "Access to the Nobus Gateway file system configuration",
	},
	api: {
		label: "API / CLI",
...
> = {
	...
	traefikFiles: {
		read: {
			label: "Read",
			description: "View gateway configuration files",
		},
		write: {
			label: "Write",
			description: "Edit and save gateway configuration files",
		},
	},
	api: {
		read: {
				...
				<CardContent className="border-t pt-6">
					<EnterpriseFeatureGate
						lockedProps={{
							title: "Custom Roles",
							description:
								"Custom roles with fine-grained permissions are part of Nobus Enterprise. Add a valid license to create and assign custom roles.",
