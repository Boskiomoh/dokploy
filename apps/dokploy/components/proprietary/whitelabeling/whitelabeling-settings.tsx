...
const DEFAULT_CSS_TEMPLATE = `/* ============================================
   Nobus Cloud Default Theme - CSS Variables
							...
							<FormField
								...
								render={({ field }) => (
									<FormItem>
										...
										<FormControl>
											<Input placeholder="Nobus Cloud" {...field} />
										</FormControl>
										<FormDescription>
											Replaces "Nobus Cloud" across the entire interface.
										</FormDescription>
										<FormMessage />
									</FormItem>
								)}
								...
								render={({ field }) => (
									<FormItem>
										...
										<FormDescription>
											...
											the standard Nobus Cloud description if empty.
										</FormDescription>
										<FormMessage />
									</FormItem>
								)}
							...
							<FormField
								...
								render={({ field }) => (
									<FormItem>
										...
										<FormDescription>
											Browser tab title. Defaults to "Nobus Cloud" if empty.
										</FormDescription>
										<FormMessage />
									</FormItem>
								)}
