						...
						<div className="p-6">
							<EnterpriseFeatureGate
								lockedProps={{
									...
									description:
										"Single sign-on (SSO) with OIDC and SAML is part of Nobus Enterprise. Add a valid license to configure it.",
					...
					<div className="rounded-xl bg-background shadow-md">
						<EnterpriseFeatureGate
							lockedProps={{
								...
								description:
									"Protect deployed applications behind an OIDC SSO gate (oauth2-proxy). Part of Nobus Enterprise.",
								ctaLabel: "Go to License",
							}}
						>
							<ForwardAuthServers />
						...
						<div className="rounded-xl bg-background shadow-md">
							<EnterpriseFeatureGate
								lockedProps={{
									...
									description:
										"Deployment and authentication restrictions are part of Nobus Enterprise. Add a valid license to configure them.",
									ctaLabel: "Go to License",
								}}
							>
								<CardHeader>
